...
- Detect brute force password attempts at a higher level of abstraction than IP Source - which may be impacted by NAT or botnet like behaviour using multiple IP Sources.
